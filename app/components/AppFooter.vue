<template>
  <footer class="bg-[var(--bg-secondary)] py-12 border-t border-black/10">
    <div class="max-w-7xl mx-auto px-5">
      <div class="grid lg:grid-cols-3 gap-8 mb-8">
        <div>
          <h3 class="text-base font-semibold mb-2">Fellip Martins — MR</h3>
          <p class="text-sm text-[var(--text-secondary)]">Representante Comercial Especializado</p>
          <p class="text-sm text-[var(--text-secondary)]">São Paulo, SP</p>
        </div>
        <div>
          <h3 class="text-base font-semibold mb-2">Contato</h3>
          <p class="text-sm text-[var(--text-secondary)]">E-mail: fellip.martins@gmail.com</p>
          <p class="text-sm text-[var(--text-secondary)]">Telefone: (11) 94229-0168</p>
          <p class="text-sm text-[var(--text-secondary)]">Horário: Seg - Sex: 9h às 18h</p>
        </div>
        <div>
